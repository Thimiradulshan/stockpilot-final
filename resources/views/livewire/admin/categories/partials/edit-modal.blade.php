                    ...
                    <div class="space-y-5 px-6 py-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows="4"
                                class="w-full resize-none rounded-xl border border-[#E2E2E2] bg-white px-4 py-3 text-sm text-[#143732] focus:border-[#015B63] focus:outline-none focus:ring-4 focus:ring-[#015B63]/10 dark:border-[#3F3F3F] dark:bg-[#3A3A3A] dark:text-[#EAEAEA] dark:focus:border-[#4FC3C7]"
                            ></textarea>
                        </div>
